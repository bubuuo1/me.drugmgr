-- Central validity check used both while claiming and immediately before send.
...
-- Recheck a claimed delivery against the latest schedule and log state.
-- Invalid work is marked skipped before any external Web Push request is made.
